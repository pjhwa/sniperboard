...
export function SentimentBoard() {
  ...
  return (
    ...
    <div className="board fade-in" style={{ gridTemplateColumns: '380px 1fr', gridTemplateRows: 'auto 1fr auto', alignContent: 'start' }}>
      ...
      {/* Top News 모바일 전용 — 데스크톱에서는 Market Sentiment 카드 안에 포함됨 */}
      <details className="mob-collapse mob-order-3 hide-mobile" open style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 'var(--r-md)' }}>
