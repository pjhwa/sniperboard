...
Plaid DS 기반 다크/라이트 테마 전환 지원. ⌘K 커맨드 팔레트로 종목·보드 빠른 이동.
...
> 우하단 **?** 버튼으로 용어 해설 패널(Glossary)을 열 수 있습니다 — Risk Regime 5요소, VIX 백워데이션, Market Breadth 등 초보자도 바로 이해할 수 있는 한국어 설명을 제공합니다.
