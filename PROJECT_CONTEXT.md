...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (TDD + refined Regime-conditioned weights). 9 tests. Exposed in /api/watchlist + /api/daily + improved DailyBoard card + OverviewBoard preview + WatchlistBoard. (2026-05-25) |
