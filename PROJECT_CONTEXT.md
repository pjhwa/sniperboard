...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (TDD + refined Regime-conditioned weights). 9 tests. Effective weights returned for transparency. Exposed in /api/watchlist + /api/daily + DailyBoard + WatchlistBoard. (2026-05-25) |
