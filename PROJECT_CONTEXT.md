...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (TDD + refined Regime-conditioned + reliability). Returns reliability ("high/medium/low") + notes. 11 tests. Exposed in /api/watchlist + /api/daily + UIs. (2026-05-25) |
