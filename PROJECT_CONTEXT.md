...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (TDD + refined Regime-conditioned). 9 tests. Conviction now prefers Brief's context sentiment for consistency (Task 4). Exposed in /api/watchlist + /api/daily + DailyBoard + OverviewBoard + WatchlistBoard. (2026-05-25) |
