...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (TDD + refined Regime-conditioned + reliability). Strong error handling + loading states improved. 12 tests. (2026-05-25) |
