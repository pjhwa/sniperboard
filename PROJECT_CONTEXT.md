...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (TDD + Regime-conditioned). 7 tests. Exposed in /api/watchlist + /api/daily + DailyBoard header + WatchlistBoard. (2026-05-25). |
