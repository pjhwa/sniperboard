...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (TDD + Regime-conditioned). 7 tests. Exposed in /api/watchlist + /api/daily + DailyBoard + WatchlistBoard. Task 4: brief context의 market_sentiment를 추가로 블렌딩 (2026-05-25). |
