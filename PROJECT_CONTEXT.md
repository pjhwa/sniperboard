...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (TDD + refined Regime-conditioned + reliability). Returns reliability + notes. Strong error handling (conviction 실패 시에도 watchlist/daily가 깨지지 않음). 12 tests. (2026-05-25) |
