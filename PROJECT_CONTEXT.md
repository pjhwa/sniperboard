...
| Conviction Composite Score v1 (Phase 1) | `backend/core/conviction_calculator.py` (pure TDD calculator, 40/30/30, Stage2 'score' + regime 'total' + sentiment). `backend/tests/test_conviction_calculator.py`. Exposed in /api/watchlist and /api/daily (2026-05-25). |
